...
export function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-brand-black/10 dark:border-brand-white/10">
      <Container className="grid items-center gap-16 py-20 lg:grid-cols-2 lg:py-28">
        <div>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-control border border-brand-black/15 dark:border-brand-white/15 px-6 py-3.5 text-sm font-medium text-brand-black dark:text-brand-white transition-colors hover:border-brand-blue hover:text-brand-blue"
            >
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="relative flex h-72 w-72 items-center justify-center rounded-card border border-brand-black/10 dark:border-brand-white/10 bg-brand-white dark:bg-brand-black shadow-[0_1px_0_0_rgba(17,17,17,0.04)] sm:h-96 sm:w-96">
