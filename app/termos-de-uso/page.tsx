    ...
    <section className="py-20">
      <Container className="max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-brand-black/70 dark:text-brand-white/70">
          ...
          <div>
            <h2 className="text-lg font-semibold text-brand-black dark:text-brand-white">1. Aceitação dos termos</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-lg font-semibold text-brand-black dark:text-brand-white">2. Uso do site</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-lg font-semibold text-brand-black dark:text-brand-white">3. Contratação de serviços</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-lg font-semibold text-brand-black dark:text-brand-white">4. Limitação de responsabilidade</h2>
            <p className="mt-2">
          ...
          <div>
            <h2 className="text-lg font-semibold text-brand-black dark:text-brand-white">5. Alterações destes termos</h2>
            <p className="mt-2">
