...
export const metadata: Metadata = {
  ...
  description:
    "Conheça o InfinityFy, o sistema de gestão empresarial da ASM Tecnologia: vendas, PDV, estoque, financeiro, compras, DRE, WMS e catálogo digital.",
};
  ...
  return (
    <>
      <section className="border-b border-brand-black/10 py-20">
        <Container>
          <Badge>Uma solução ASM Tecnologia</Badge>
          ...
          <p className="mt-4 max-w-xl text-lg leading-relaxed text-brand-black/70">
            ...
            plataforma — desenvolvida e mantida pela ASM Tecnologia.
          </p>
